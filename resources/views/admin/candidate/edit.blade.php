                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="candidate_number" name="candidate_number"
                                        value="{{ old('candidate_number', $candidate->candidate_number) }}" placeholder="Enter candidate_number">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="photo" name="photo"
                                        value="{{ old('photo', $candidate->photo) }}" placeholder="Enter photo">
                                    @error('photo')
                                        <small class="form-text text-danger">
                                            {{ $message }}
                                        </small>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control"id="vision_mission" name="vision_mission" placeholder="Text">
                                        {{ old('vision_mission', $candidate->vision_mission) }}
                                    </textarea>
